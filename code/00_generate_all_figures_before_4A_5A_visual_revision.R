...
# Shared Figure 4A/5A revision palette. Exact template colors were not
# recoverable as hard-coded values; use the requested manuscript colors.
GROUP_PALETTE_4A_5A <- c(
	untreated_opa1floxed_vilcre_d0 = "#0015FF",
